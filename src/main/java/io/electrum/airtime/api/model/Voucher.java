...
public class Voucher   {
  ...
  /**
   * The voucher's PIN used by the customer to redeem the voucher. This must be present in VoucherResponse messages. It is recommended this field not be populated in other instances.
   **/
  ...
  @ApiModelProperty(value = "The voucher's PIN used by the customer to redeem the voucher. This must be present in VoucherResponse messages. It is recommended this field not be populated in other instances.")
  @JsonProperty("pin")
  ...
  /**
   * An array of free text lines which provide the customer with information on how to redeem the voucher. This are intended to be printed on a customer's receipt slip.
   **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(pin, voucher.pin) &&
        Objects.equals(serialNumber, voucher.serialNumber) &&
