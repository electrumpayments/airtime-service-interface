...
public class Merchant   {
  ...
  /**
   * The ID that uniquely identifies each device or system in a merchant institution capable of sending requests. Required for transactions initiated from physical card entry or point-of-sale devices.
   **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(merchantType, merchant.merchantType) &&
        Objects.equals(merchantId, merchant.merchantId) &&
        Objects.equals(merchantName, merchant.merchantName) &&
        Objects.equals(terminalId, merchant.terminalId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(merchantType, merchantId, merchantName, terminalId);
  }
