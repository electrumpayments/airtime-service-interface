...
public abstract class VouchersResource {
	...
	public class ConfirmVoucher {
		...
		public static final String PATH = "/{" + PathParameters.REQUEST_ID + "}/confirmations/{"
	...
	public class ReverseVoucher {
		...
		public static final int SUCCESS = 202;
		public static final String PATH = "/{" + PathParameters.REQUEST_ID + "}/reversals/{"
	...
	public final void confirmVoucher(
		...
		getResourceImplementation().confirmVoucherImpl(requestId, confirmationId, body, securityContext, request,
				httpHeaders, asyncResponse, uriInfo, httpServletRequest);
	}
	...
	/**
	 * This operation has been deprecated. Use
	 * {@link PurchaseResource#purchase(PurchaseRequest, SecurityContext, Request,
	 * AsyncResponse, HttpHeaders, UriInfo,
	 * HttpServletRequest)(PurchaseConfirmation, SecurityContext, Request,
	...
	public final void provisionVoucher(
			...
			@Context HttpHeaders httpHeaders, @Context UriInfo uriInfo,
			@Context HttpServletRequest httpServletRequest) {
		getResourceImplementation().provisionVoucherImpl(requestId, body, securityContext, request, httpHeaders,
				asyncResponse, uriInfo, httpServletRequest);
	}
	...
	/**
	 * This operation has been deprecated. Use
	 * {@link PurchaseResource#reversePurchase(PurchaseReversal, SecurityContext,
	 * Request, AsyncResponse, HttpHeaders, UriInfo,
	 * HttpServletRequest)(PurchaseRequest, SecurityContext, Request, AsyncResponse,
	 * HttpHeaders, UriInfo, HttpServletRequest)(PurchaseConfirmation,
	 * SecurityContext, Request, AsyncResponse, HttpHeaders, UriInfo,
	...
	public final void reverseVoucher(
			...
			@Context HttpHeaders httpHeaders, @Context UriInfo uriInfo,
			@Context HttpServletRequest httpServletRequest) {
		getResourceImplementation().reverseVoucherImpl(requestId, reversalId, body, securityContext, request,
				httpHeaders, asyncResponse, uriInfo, httpServletRequest);
	}
}
